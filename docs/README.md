...
[Windows PowerShell](WindowsPowerShell.md) which is part of operating system.
...
Windows Server 2008 see [Legacy Support](LegacySupport.md)
...
script again, see [FAQ](FAQ.md) for more information on why this may happen.
...
For more information see: [Manage GPO Firewall](ManageGPOFirewall.md)

1. Editing PowerShell scripts, this method gives you full control, you can change or remove existing
...
For additional information and troubleshooting tips see also [Remoting help](Remote.md)
