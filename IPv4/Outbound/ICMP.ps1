...
-Direction Outbound -Protocol ICMPv4 -IcmpType 0 -LocalAddress Any -RemoteAddress LocalSubnet4 `
...
-Direction Outbound -Protocol ICMPv4 -IcmpType 0 -LocalAddress Any -RemoteAddress 169.254.1.0-169.254.254.255 `
-Localuser $NT_AUTHORITY_SYSTEM -Description $Description
